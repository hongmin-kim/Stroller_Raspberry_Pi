...
if __name__ == "__main__":
    ...
    if debug == True:
        ...
        led_process = multiprocessing.Process(target=alarm_led_debug, args=(response_queue_led, ))
        led_process.start()
    else:
        ...
        led_process = multiprocessing.Process(target=alarm_led, args=(response_queue_led, ))
        led_process.start()
